    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        <Text style={styles.placeholder}>
          Politica de confidențialitate – descrie modul în care aplicația ABA Professional colectează, utilizează și protejează datele dumneavoastră personale.
        </Text>
        <Text style={styles.paragraph}>
          Conținutul complet al politicii de confidențialitate va fi afișat aici.
        </Text>
      </ScrollView>
    </View>
  );
